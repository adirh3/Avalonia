...
//             var items = new[]
//             {
//                 new DataGridItemWrapper { Item = new Item("b", "b") },
//                 new DataGridItemWrapper { Item = new Item("a", "a") },
//                 new DataGridItemWrapper { Item = new Item("c", "c") },
//             };
//             var expectedResult = items.OrderBy(i => i.Item.Prop1).ToList();
